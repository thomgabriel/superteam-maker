...
export const INFRA_IDEAS: CuratedIdea[] = [
  {
    ...
    "judgeHook": "Na demo, o time cola um IDL, preenche parâmetros e executa uma chamada que normalmente exigiria script, mostrando ganho real de produtividade em segundos.",
    "buildScore": "medium",
    "painScore": 2,
    "cryptoScore": 3,
  ...
  },
  {
    ...
    "judgeHook": "O jurado vê uma transação falhada, um log impossível de ler e, na sequência, uma explicação clara do erro com caminho provável de correção.",
    "buildScore": "medium",
    "painScore": 2,
    "cryptoScore": 3,
    "confidenceNote": "Vale manter quando a entrega economiza tempo real e o antes/depois da demo fica muito nítido.",
  ...
  },
  {
    ...
    "judgeHook": "Funciona bem ao vivo porque responde a uma pergunta concreta: o app está saudável ou quebrando, e em qual parte do fluxo isso aparece.",
    "buildScore": "medium",
    "painScore": 2,
    "cryptoScore": 3,
    "confidenceNote": "Vale manter quando a entrega economiza tempo real e o antes/depois da demo fica muito nítido.",
  ...
  },
  {
    ...
    "judgeHook": "Fica forte na apresentação porque entra material cru e sai uma documentação navegável com exemplos prontos para quem vai integrar.",
    "buildScore": "medium",
    "painScore": 2,
    "cryptoScore": 3,
    "confidenceNote": "Vale manter quando a entrega economiza tempo real e o antes/depois da demo fica muito nítido.",
  ...
  },
  {
    ...
    "judgeHook": "A demo vende fácil: em vez de cinco ferramentas abertas, o desenvolvedor usa uma wallet de teste única para trocar rede, pedir airdrop e ler logs.",
    "buildScore": "medium",
    "painScore": 2,
    "cryptoScore": 3,
    "confidenceNote": "Vale manter quando a entrega economiza tempo real e o antes/depois da demo fica muito nítido.",
  ...
  },
  {
    ...
    "targetUser": "Builders, maintainers e times pequenos prestes a publicar um app ou programa e sem tempo para uma revisão formal de segurança.",
    "painPoint": "Na correria do deploy, permissões, chaves, variáveis e autoridades ficam fáceis de esquecer, e um erro pequeno pode estragar a demo ou gerar risco real.",
    "cryptoAngle": "Em produtos onchain, detalhes como upgrade authority, permissões e contas expostas importam muito, então um checklist específico para cripto entrega valor imediato.",
    ...
    "judgeHook": "Na apresentação, o time passa por um checklist curto e encontra riscos que normalmente só apareceriam tarde demais, o que deixa o valor muito visível.",
    "buildScore": "easy",
    "painScore": 2,
    "cryptoScore": 2,
    "confidenceNote": "Boa ideia para hackathon porque transforma prevenção em interface concreta e evita um tipo de erro que todo builder teme perto da entrega.",
    "featured": false,
    "editorialTracks": [
      "demo-friendly",
      "community-growth",
  ...
  },
  {
    ...
    "judgeHook": "É uma demo simples e boa: todos os serviços do projeto aparecem em um painel único, deixando claro o que está pronto para ser mostrado e o que ainda está frágil.",
    "buildScore": "medium",
    "painScore": 2,
    "cryptoScore": 3,
    "confidenceNote": "Vale manter quando a entrega economiza tempo real e o antes/depois da demo fica muito nítido.",
  ...
  },
  {
    ...
    "judgeHook": "O before and after aparece rápido: um produto vazio ganha carteiras, transações e usuários plausíveis, ficando pronto para uma demo convincente.",
    "buildScore": "medium",
    "painScore": 2,
    "cryptoScore": 3,
    "confidenceNote": "Vale manter quando a entrega economiza tempo real e o antes/depois da demo fica muito nítido.",
  ...
  },
  {
    ...
    "judgeHook": "É fácil vender porque pega a dor mais comum da submissão final: links quebrados, demos fora do ar e material incompleto, e resolve tudo em um passe só.",
    "buildScore": "medium",
    "painScore": 2,
    "cryptoScore": 3,
    "confidenceNote": "Vale manter quando a entrega economiza tempo real e o antes/depois da demo fica muito nítido.",
  ...
  },
  {
    ...
    "judgeHook": "Na demo, um program id vira uma timeline legível de eventos, o que ajuda qualquer jurado a enxergar atividade onchain sem abrir explorer técnico.",
    "buildScore": "medium",
    "painScore": 2,
    "cryptoScore": 3,
    "confidenceNote": "Vale manter quando a entrega economiza tempo real e o antes/depois da demo fica muito nítido.",
  ...
  },
  {
    ...
    "judgeHook": "Funciona ao vivo porque o time mostra código repetitivo desaparecendo e um SDK mínimo surgindo pronto para integrar no frontend.",
    "buildScore": "medium",
    "painScore": 2,
    "cryptoScore": 3,
    "confidenceNote": "Vale manter quando a entrega economiza tempo real e o antes/depois da demo fica muito nítido.",
  ...
  },
  {
    ...
    "judgeHook": "A apresentação fica mais forte porque o jurado acompanha o que acontece por baixo dos panos sem depender de console, explorer ou explicação longa.",
    "buildScore": "medium",
    "painScore": 2,
    "cryptoScore": 3,
    "confidenceNote": "Vale manter quando a entrega economiza tempo real e o antes/depois da demo fica muito nítido.",
  ...
  },
  {
    ...
    "judgeHook": "O valor fica claro quando um projeto frágil ganha um ambiente estável de demo com checklist, dados simulados e menos chance de passar vergonha ao vivo.",
    "buildScore": "medium",
    "painScore": 2,
    "cryptoScore": 3,
    "confidenceNote": "Vale manter quando a entrega economiza tempo real e o antes/depois da demo fica muito nítido.",
  ...
  },
  {
    ...
    "judgeHook": "Na demo, a mesma transação aparece lado a lado em vários exploradores e o produto evidencia por que um resumo próprio ainda ajuda tanto.",
    "buildScore": "medium",
    "painScore": 2,
    "cryptoScore": 3,
    "confidenceNote": "Vale manter quando a entrega economiza tempo real e o antes/depois da demo fica muito nítido.",
  ...
  },
  {
    ...
    "targetUser": "Times de hackathon, builders independentes e founders técnicos que submetem projetos correndo e quebram detalhes bobos no último minuto.",
    "painPoint": "Submissões falham por causa de imagem errada, link quebrado, metadado faltando ou descrição inconsistente, mesmo quando o produto está bom.",
    "cryptoAngle": "Projetos cripto dependem muito de links, explorers, demos, repositórios e prova pública, então validar o pacote inteiro aumenta a confiança na entrega.",
    ...
    "judgeHook": "É uma demo objetiva: o time cola os links do projeto e o validador aponta o que deixaria a submissão fraca ou quebrada antes do prazo final.",
    "buildScore": "easy",
    "painScore": 2,
    "cryptoScore": 2,
    "confidenceNote": "Muito útil para público de hackathon porque resolve um erro banal, frequente e doloroso sem depender de integração complexa.",
    "featured": false,
    "editorialTracks": [
      "demo-friendly",
      "community-growth",
  ...
  },
  {
    ...
    "judgeHook": "O jurado vê um erro chato de Anchor virar uma explicação curta e acionável em português, o que comunica valor imediatamente para qualquer builder.",
    "buildScore": "medium",
    "painScore": 2,
    "cryptoScore": 3,
    "confidenceNote": "Vale manter quando a entrega economiza tempo real e o antes/depois da demo fica muito nítido.",
  ...
  },
  {
    ...
    "judgeHook": "Na apresentação, um arquivo técnico se transforma em uma página testável e bonita, facilitando integração e deixando o projeto mais apresentável.",
    "buildScore": "medium",
    "painScore": 2,
    "cryptoScore": 3,
    "confidenceNote": "Vale manter quando a entrega economiza tempo real e o antes/depois da demo fica muito nítido.",
